...
// Create a function called 'lovesCodeChecker' that takes in a single parameter called 'x'. Check to see if 'x' is equal to true. If it is, 
// return a true boolean. If 'x' does not equal true, return a false boolean.  
...
// Create a function called 'oddChecker' that takes in one parameter, 'num'. Your function should check to see if the parameter 
// is even or odd. If the parameter is odd, return 'the number is odd'. If the number is even, return 'the number is even'.
...
// providence of residence as a string. The value of age should be your age as a number. greeter should be a method that 
// returns the string 'Hello! My name is NAMEVALUE and I live in STATEVALUE' with the corresponding values. 
...
// (this means your counter should decrement), and then add each item to the 'reversed' array variable you created. 
...
// Did you know that George Foreman has five sons named George? Go ahead and change everyone's 
// name in the notGeorge array to George using .map. Store the resulting array in a variable named 'forTheLoveOfGeorge'.
